...
const Footer: React.FC = () => {
  return (
    <div className="self-stretch bg-black p-8 md:p-[70px] mt-12 rounded-[40px] shadow-xl font-bakbak">
      <div className="flex flex-col md:flex-row items-start self-stretch mb-[40px] gap-12">
        <div className="flex flex-1 flex-col items-start gap-7">
          <div className="flex items-center gap-3">
            <img
              src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/KQqb07sxCU/jdcxnn46_expires_30_days.png"
        ...
        <div className="grid grid-cols-2 gap-16 md:gap-24 font-inter">
          <div className="flex flex-col items-start gap-4 text-gray-500 font-semibold">
          ...
          <div className="flex flex-col items-start gap-4 text-gray-500 font-semibold">
            <span className="text-white text-xl font-bakbak">Contacto</span>
      ...
      <div className="w-full h-[1px] bg-gray-800 mb-[35px]" />
