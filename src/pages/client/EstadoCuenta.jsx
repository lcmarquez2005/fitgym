...
// IMPORTAMOS LOS ICONOS DE LUCIDE DIRECTAMENTE
import { Menu, ArrowLeft, Star, Dumbbell } from "lucide-react";
    ...
    <div className="flex h-screen bg-[#9FDDFF] overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col h-full overflow-y-auto bg-[#F6F8FE] rounded-tl-[40px]">
        ...
        <div className="bg-[#9FDDFF] w-full py-8 px-8 shrink-0 flex items-center gap-4">
          ...
          {/* Botón de regresar a Socio */}
          <button
            onClick={() => navigate("/socio")}
            className="p-2 rounded-xl bg-white/60 hover:bg-white transition-colors flex items-center justify-center shadow-sm"
            title="Regresar a Perfil del Socio"
          >
            <ArrowLeft size={22} color="#000" /> 
          </button>

          <h1 className="text-black text-3xl font-normal opacity-80 ml-2">
            Estado de Cuenta
          </h1>
        </div>
        ...
        <div className="flex flex-col xl:flex-row gap-6 px-8 -mt-6 pb-10 items-stretch">
          ...
          <div className="bg-white rounded-[32px] p-8 shadow-sm flex flex-col items-center w-full xl:w-5/12 relative">
            ...
            <div className="flex gap-3 mt-8 w-full justify-center flex-wrap">
              ...
              <button onClick={() => navigate('/checkout')} className="bg-[#FBBB62] hover:bg-[#eeb15b] text-white text-sm font-bold py-3 px-6 rounded-3xl min-w-[100px] transition-transform active:scale-95">
                Renovar
              </button>
              <button onClick={() => navigate('/checkout')} className="bg-[#FF6500] hover:bg-[#e55b00] text-white text-sm font-bold py-3 px-6 rounded-3xl min-w-[100px] transition-transform active:scale-95">
                Cobrar
              </button>
              <button
